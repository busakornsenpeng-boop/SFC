...
// เปิดจาก "ชี้ (hover)" การ์ด KPI แทนการคลิก — แต่ปิดแบบดีเลย์นิดหน่อย (250ms)
// กันไม่ให้ modal หายวับตอนขยับเมาส์จากการ์ดไปยัง modal (ซึ่งอยู่กลางจอ คนละตำแหน่งกับการ์ด)
// ถ้าเมาส์เข้าไปอยู่ใน modal ทัน ตัวจับเวลานี้จะถูกยกเลิกโดย cancelCloseDeptBreakdown()
let dbmCloseTimer = null;
function scheduleCloseDeptBreakdown(){
  clearTimeout(dbmCloseTimer);
  dbmCloseTimer = setTimeout(() => closeModal('dept-breakdown-modal'), 250);
}
